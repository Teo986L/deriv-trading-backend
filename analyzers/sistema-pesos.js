...
class SistemaPesosAutomaticos {
    ...
    analisarMercado(candles, precoAtual) {
        ...
        this.atualizarHistorico({ timestamp: Date.now(), tendencia, volatilidade, momentum, consolidacao, estado: this.estadoMercado, pesos });
    ...
    gerarPesosAutomaticos(tendencia, volatilidade, momentum, consolidacao) {
        ...
        for (const [key, value] of Object.entries(basePesos)) {
            ...
            if (typeof value === 'number') pesosAjustados[key] = value * ajuste;
            else pesosAjustados[key] = value;
        }
    ...
    calcularAjustesPorEstado(estado) {
        const ajustes = { adx: 1.0, timeframes: 1.0, indicadores: 1.0, rsi: 1.0, sensibilidade: 1.0, agressividade: 1.0 };
        switch (estado) {
            case "CONSOLIDACAO":
                ajustes.adx = 0.6; ajustes.indicadores = 0.8; ajustes.sensibilidade = 1.1; ajustes.agressividade = 0.8;
                break;
            case "VOLATIL_ALTO":
                ajustes.adx = 1.0; ajustes.timeframes = 0.9; ajustes.sensibilidade = 1.0; ajustes.agressividade = 0.9;
                break;
            case "TENDENCIA_ALTA":
            case "TENDENCIA_BAIXA":
                ajustes.adx = 1.2; ajustes.indicadores = 1.3; ajustes.timeframes = 1.2; ajustes.sensibilidade = 1.3; ajustes.agressividade = 1.3;
                break;
            case "MOMENTUM_ALTA_FORTE":
            case "MOMENTUM_BAIXA_FORTE":
                ajustes.adx = 1.0; ajustes.indicadores = 1.5; ajustes.timeframes = 1.1; ajustes.sensibilidade = 1.5; ajustes.agressividade = 1.7;
                break;
            case "VOLATIL":
                ajustes.adx = 0.9; ajustes.indicadores = 1.1; ajustes.sensibilidade = 1.1; ajustes.agressividade = 1.0;
                break;
            default:
                ajustes.adx = 0.8; ajustes.indicadores = 1.1; ajustes.timeframes = 1.1; ajustes.sensibilidade = 1.1; ajustes.agressividade = 1.1;
        }
        return ajustes;
    }
